...
Read-only ограничение относилось к первоначальному этапу перехода из
уведомления. Позднее внутренний UI получил действия ролей; текущий состав
сверять с `Docs/RDM-ROADMAP.md` и кодом.
