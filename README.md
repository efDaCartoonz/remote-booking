...
L1. Актуальный stage-стенд: Raspberry Pi `172.17.131.115`.
...
```bash
cd backend
pytest tests/test_cards.py tests/test_frame_api.py tests/test_l2_distribution.py tests/test_l1_distribution.py
```
